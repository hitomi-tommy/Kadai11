...
class NearestStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nearest_station" do
    assert_difference('NearestStation.count') do
      post nearest_stations_url, params: { nearest_station: { railway_line: @nearest_station.railway_line, station_name: @nearest_station.station_name, time_to_station: @nearest_station.time_to_station } }
    end
  ...
  test "should update nearest_station" do
    patch nearest_station_url(@nearest_station), params: { nearest_station: { railway_line: @nearest_station.railway_line, station_name: @nearest_station.station_name, time_to_station: @nearest_station.time_to_station } }
